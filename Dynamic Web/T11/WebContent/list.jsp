...
String DB_URL = "jdbc:mariadb://localhost:3306/mydb?allowPublicKeyRetrieval=true&useSSL=false";
...
&nbsp;&nbsp;&nbsp;
<input type="button" onClick ="delete_multi()" value ="선택삭제">
...
%><tr>
	<td>
		<input type = "checkbox" name="selected_idx" value="<%=rs.getInt("idx") %>">
	</td>
	<td><%=rs.getInt("idx") %></td>
