...
window.onload = function(){
	document.getElementById("sendAll").onClick =function{
			var title = getElementByName("videoTitle");
			var description = getElementByName("videoDescription");
	...
	<form method="get" action="manageVid.jsp">
    ...
    <section>
        ...
        <div class = "videoInfo">
            <table>
                ...
                <tr>
                    <td><br><br>
                        <button type="submit" id = "sendAll" onClick="isFull()">제출</button>
                    </td>
                </tr>
            </table>
        </div>
